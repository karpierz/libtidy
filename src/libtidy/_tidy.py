...
class TidyAllocatorVtbl(ct.Structure):
    ...
    ("*alloc",  CFUNC(ct.c_void_p,
                      ct.POINTER(TidyAllocator),  # self   # The TidyAllocator to use to alloc memory.
    ...
    #
    ("free",    CFUNC(None,
                      ct.POINTER(TidyAllocator),  # self, # The TidyAllocator to use to free memory.
    ...
    #
    ("panic",   CFUNC(None,
                      ct.POINTER(TidyAllocator),  # self # The TidyAllocator to use to panic.
